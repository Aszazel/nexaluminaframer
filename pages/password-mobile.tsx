...
const PasswordMobile: NextPage = () => {
  return (
    <div className="relative bg-neutral-100 w-full h-[1270px] overflow-hidden text-left text-base text-neutral-0 font-block-quote">
      ...
      <div className="absolute top-[366px] left-[20px] rounded-md bg-neutral-100 w-[335px] flex flex-row items-center justify-start py-3.5 px-4 box-border text-center text-sm text-neutral-40">
        <div className="relative leading-[20px]">Enter your password</div>
      </div>
      <div className="absolute top-[431px] left-[20px] rounded-6xs box-border w-[335px] h-12 flex flex-row items-center justify-center py-3 px-12 gap-[8px] text-lg text-neutral-100 border-[1px] border-solid border-neutral-100">
        <img
          className="relative w-6 h-6 object-cover hidden"
          alt=""
          src="/iconsplaceholderplaceholder@2x.png"
        />
        <div className="relative leading-[24px] capitalize">Submit</div>
        <img
          className="relative w-6 h-6 object-cover hidden"
          alt=""
          src="/iconsplaceholderplaceholder@2x.png"
      ...
      <div className="absolute top-[205px] left-[20px] text-37xl leading-[60px] text-neutral-100">
        <p className="m-0">Protected</p>
