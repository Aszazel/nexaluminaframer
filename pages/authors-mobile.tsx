...
const AuthorsMobile: NextPage = () => {
  return (
    <div className="relative bg-neutral-100 w-full h-[2176px] overflow-hidden text-left text-5xl text-neutral-0 font-block-quote">
      <div className="absolute top-[0px] left-[0px] bg-neutral-100 box-border w-[375px] flex flex-col items-start justify-start text-center text-base border-b-[1px] border-solid border-neutral-90">
      ...
      <div className="absolute bottom-[0px] left-[0px] bg-neutral-100 box-border w-[375px] flex flex-col items-start justify-start py-10 px-5 gap-[24px] text-base border-t-[1px] border-solid border-neutral-80">
      ...
      <div className="absolute top-[128px] left-[21px] text-xl tracking-[0.15em] leading-[24px] uppercase font-semibold text-neutral-60">
        AUTHORS
      </div>
      <div className="absolute top-[168px] left-[20px] text-13xl leading-[40px]">
        Our Contributors
      </div>
      <div className="absolute top-[224px] left-[20px] text-xl leading-[28px] text-neutral-50 inline-block w-[332px]">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
        varius enim in eros elementum tristique. Duis cursus, mi quis viverra
        ornare, eros dolor interdum.
      </div>
      <div className="absolute top-[412px] left-[20px] rounded-3xs bg-neutral-100 box-border w-[335px] flex flex-col items-center justify-start p-5 gap-[12px] border-[1px] border-solid border-neutral-0">
        ...
        <div className="self-stretch relative leading-[32px] text-center">
          Isaiah Trotter
        </div>
        <div className="self-stretch relative text-sm leading-[20px] text-neutral-50">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
          varius enim in eros elementum tristique. Duis cursus, mi quis viverra
          ornare, eros dolor interdum.
        </div>
        <div className="self-stretch rounded-md bg-neutral-0 flex flex-row items-center justify-center py-3 px-12 gap-[8px] text-lg text-neutral-100">
          <img
            className="relative w-6 h-6 object-cover hidden"
            alt=""
            src="/iconsplaceholderplaceholder@2x.png"
          />
          <div className="relative leading-[24px] capitalize">See profile</div>
          <img
            className="relative w-6 h-6 object-cover hidden"
            alt=""
            src="/iconsplaceholderplaceholder@2x.png"
      ...
      <div className="absolute top-[749px] left-[20px] rounded-3xs bg-neutral-100 box-border w-[335px] flex flex-col items-center justify-start p-5 gap-[12px] border-[1px] border-solid border-neutral-0">
      ...
      <div className="absolute top-[1086px] left-[20px] rounded-3xs bg-neutral-100 box-border w-[335px] flex flex-col items-center justify-start p-5 gap-[12px] border-[1px] border-solid border-neutral-0">
        <div className="rounded-981xl w-[77px] h-[77px] flex flex-row items-start justify-start bg-[url('/rectangle-5@2x.png')] bg-cover bg-no-repeat bg-[top]">
          <img
            className="self-stretch flex-1 relative rounded-81xl max-w-full overflow-hidden max-h-full object-cover"
            alt=""
